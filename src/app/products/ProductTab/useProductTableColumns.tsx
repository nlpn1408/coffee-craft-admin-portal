...
import { Table, Button, Space, Popconfirm, Tag, Image, InputRef, Menu, Dropdown } from "antd";
...
interface UseProductTableColumnsProps {
  ...
  // queryParams: { sortField?: string; sortOrder?: 'ascend' | 'descend'; filters: Record<string, FilterValue | null> };
...
export const useProductTableColumns = ({
  ...
  isDeleting = false,
}: UseProductTableColumnsProps): TableProps<Product>["columns"] => {
