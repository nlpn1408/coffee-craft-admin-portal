...
import ProductVariantTab from './ProductVariantTab/ProductVariantTab';
import ProductImageTab from './ProductImageTab/ProductImageTab';
// Removed TagTab import
import { ProductFormFields } from './ProductTab/ProductFormFields'; // Use named import
        ...
        items.push(
            {
                ...
                children: <ProductVariantTab selectedProduct={product} isViewMode={isViewMode} />,
            },
            {
                key: 'images',
                label: 'Images',
                 // Pass isViewMode down
                children: <ProductImageTab selectedProduct={product} isViewMode={isViewMode} />,
            }
            // Removed Tags tab
        );
    }
